					...
					"ui.combobox",
					{
						_create : function() {
							...
							input.data("autocomplete")._renderItem = function(
									ul, item) {
								return $("<li></li>").css("font-size", "62%").data("item.autocomplete",
										item).append(
							...
							$("<a>").css({
								...
								"height" : "21px"
									...
									"Show All Items").appendTo(wrapper).button(
									{
										icons : {
									...
									"ui-corner-right ui-button-icon").click(
									function() {
										...
										// work around a bug (likely same cause
										// as #5265)
										$(this).blur();
